...
tipos=["mergesort.txt","quicksort.txt","selectionsort.txt","sort.txt"]
...
plt.tight_layout()
plt.savefig(path_plots+"Grafico_tiempos.png")  # Guardar imagen
...
plt.xticks(rotation=90)
plt.tight_layout()
plt.savefig(path_plots+"Grafico_memoria.png")  # Guardar imagen